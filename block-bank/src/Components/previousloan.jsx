...
const PrevLoanTable = () => {
    ...
    return (
        <div className="container mx-auto">
            <h1 className="text-2xl font-bold my-5 text-center "> Privious Loan Data</h1>
            <table className="bg-white border border-gray-200 w-full">
                <thead>
                    <tr className="font-semibold py-5 " >
                ...
                <tbody  >
                    {loanData.map((loan) => (
                        <tr key={loan.id} className="hover:bg-gray-100">
                            <td className="py-2 px-10 border-b">₹{loan.loanAmount.toLocaleString()}</td>
                            <td className="py-2 px-10 border-b">{loan.interest}%</td>
                            <td className="py-2 px-10 border-b">{loan.createdDate}</td>
                            <td className="py-2 px-10 border-b">{loan.dueDate}</td>
                            <td className="py-2 px-10 border-b">{loan.paidDate}</td>
                            <td className="py-2 px-10 border-b text-center">
